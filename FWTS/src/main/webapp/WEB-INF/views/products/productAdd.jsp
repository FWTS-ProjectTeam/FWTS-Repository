			...
			<div class="product-container">
				...
				<form id="productForm" method="POST" enctype="multipart/form-data">
					<div class="pro-info1">
						...
						<div class="pro-detail">
							...
							<div class="pro-detail2">
								<p>
									상품명: <input type="text" name="proName" value="${product.proName}">
								</p>
								<label for="isSales">판매 상태:
									<select name="isSales" id="isSales">
										<option value="1" ${product.sales ? 'selected' : ''}>판매 중</option>
										<option value="0" ${!product.sales ? 'selected' : ''}>판매 중지</option>
									</select>
								</label>
								<p>
									최소 구매 가능 수량: <input type="number" name="minPossible" value="${product.minPossible}">
								</p>
								<p>
									최대 구매 가능 수량: <input type="number" name="maxPossible" value="${product.maxPossible}">
								</p>
								<p>
									재고: <input type="number" name="inventory" value="${product.inventory}">
								</p>
								<p>
									가격: <input type="number" name="unitPrice" value="${product.unitPrice}">
								</p>
								<p>
									배송비: <input type="number" name="deliveryFee" value="${product.deliveryFee}">
								</p>
								<label for="categoryId">카테고리:
					...
					<div class="button-container">
						...
						<button type="submit" class="btn2" onclick="confirmAdd(event, '${userDetails.userId}')">등록</button>
					</div>
				</form>
			</div>
		</div>
