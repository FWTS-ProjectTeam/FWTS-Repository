...
<div class="container">
    ...
    <div class="body-container">
        ...
        <form class="post-form" id="post-form" action="/support-center/inquirys/edit" method="post">
...
<script>
	...
	function cancelAction() {
	    ...
	    // 글 작성인지, 수정인지에 따라 처리
	    if (inquiryId) {
            window.location.href = "/support-center/inquirys/" + inquiryId;
        } else {
            window.location.href = "/support-center/inquirys";
        }
	}
</script>
</body>
