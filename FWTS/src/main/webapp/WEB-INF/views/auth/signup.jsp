    ...
    <div class="container">
        ...
        <form action="/sign-up" method="post" onsubmit="return validatePassword()">
        	<div class="radio-group">
                <label for="role">사업자 유형 <span class="required">*</span></label>
            ...
            <div class="input-group">
                ...
                <div class="input-field">
	                <input type="email" id="email" name="email" value="${inputData.email}" maxlength="320">
	            ...
	            <div class="input-field">
	                <input type="text" id="postal-code" name="postalCode" readonly>
                ...
                <div class="input-field">
		            ...
		            <input type="text" id="detail-address" name="detailAddress" maxlength="30">
	            </div>
            </div>  
